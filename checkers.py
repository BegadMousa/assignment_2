...
this file is checkers.py which is the first requirment for the assignment
'''
...
# Draws pixels with alternating colors
...
# draws a checker board using Draw_alt_row() function 
